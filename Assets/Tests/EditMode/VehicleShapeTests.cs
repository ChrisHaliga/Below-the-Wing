...
namespace BelowTheWing.Tests.EditMode
{
    ...
    public sealed class ApronLayoutFromShapesTests
    {
        ...
        {
            var plan = ApronLayout.Build(OneTrain(1), new ApronEquipment(m_Tractor.Footprint, m_Cart.Footprint, TestShapes.BeltLoaderFootprint, TestShapes.AircraftFootprint, Vector3.one));
        ...
        {
            var plan = ApronLayout.Build(OneTrain(2), new ApronEquipment(m_Tractor.Footprint, m_Cart.Footprint, TestShapes.BeltLoaderFootprint, TestShapes.AircraftFootprint, Vector3.one));
