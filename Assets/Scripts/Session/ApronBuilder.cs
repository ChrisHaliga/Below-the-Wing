...
namespace BelowTheWing.Session
{
    ...
    public static class ApronBuilder
    {
            ...
            int placeInTrain = 0)
        {
            ...
            placed.GetComponent<ApronAppearance>().Show(plan.Name);
            ...
            // A vehicle changes hands only when somebody asks for it and is granted it. Marking one
            // distributable would let the netcode layer hand vehicles out one at a time whenever
            // anybody joins or leaves, splitting trains across machines behind the back of every
